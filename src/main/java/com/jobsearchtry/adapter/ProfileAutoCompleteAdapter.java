...
public class ProfileAutoCompleteAdapter extends BaseAdapter {
    private ArrayList<String> suggestionsList = new ArrayList<>();
    private ArrayList<String> arraylist;
    private Activity activity;

    public ProfileAutoCompleteAdapter(Activity a,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if ((GlobalData.profilesuggestion.size() > 0) && GlobalData.profilesuggestion.contains(suggestionsList.get(position))) {
